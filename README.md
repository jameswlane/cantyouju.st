     ...
     userLinks: [
       {
         ...
         iconClassName: "fa fa-github" index.jsx
       index.jsx       label: "Twitter",
         url: "https://twitter.com/gatsbyjs",
         iconClassName: "fa fa-twitter" index.jsx
       },
       {
         lindex.jsx
         url: "mailto:gatsbyjs@example.com",
         iconClassName: "fa fa-envelope" index.jsx
       }
     ],
     // Copyright string for the findex.jsxebsite and RSS feed.
     copyright: {
